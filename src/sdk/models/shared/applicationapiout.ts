 ...
 */
export enum ApplicationApiOutIcon {
    Bookmark = "BOOKMARK",
    Bolt = "BOLT",
    Bullhorn = "BULLHORN",
 ...
 */
export enum ApplicationApiOutType {
...
export class ApplicationApiOut extends SpeakeasyBase {
    /**

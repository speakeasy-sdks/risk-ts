 ...
 */
export enum ApplicationApiUpdateInIcon {
    Bookmark = "BOOKMARK",
    Bolt = "BOLT",
    Bullhorn = "BULLHORN",
 ...
 */
export enum ApplicationApiUpdateInType {
...
export class ApplicationApiUpdateIn extends SpeakeasyBase {
    /**
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "icon" })
    icon?: ApplicationApiUpdateInIcon;
     ...
     */
    @SpeakeasyMetadata()
    @Expose({ name: "restrictBuildAccess" })
    restrictBuildAccess?: boolean;
    ...
    @SpeakeasyMetadata()
    @Expose({ name: "type" })
    type?: ApplicationApiUpdateInType;
}

...
export class Application {
     ...
     */
    async read(
        req: operations.ReadApplicationRequest,
        config?: AxiosRequestConfig
    ): Promise<operations.ReadApplicationResponse> {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ReadApplicationRequest(req);
        }
     ...
     */
    async readAll(
        req: operations.ReadAllApplicationsRequest,
        config?: AxiosRequestConfig
    ): Promise<operations.ReadAllApplicationsResponse> {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ReadAllApplicationsRequest(req);
        }
